...
# ה-fixtures וה-DB לבדיקות חיים ב-tests/conftest.py, ו-pytest טוען אותו
# אוטומטית. אין לייבא ממנו במפורש: הייבוא טוען את הקובץ פעם שנייה תחת שם
# מודול אחר, יוצר מנוע DB שני, וה-override מצביע על בסיס נתונים ריק.
