...
const s = {
  ...
  kpiCard:   { background:"#fff", borderRadius:16, padding:"16px 20px",
  ...
  chartCard: { background:"#fff", borderRadius:16, padding:20,
               border:"1px solid #e3e7e5", boxShadow:"0 1px 2px rgba(20,24,22,0.04), 0 2px 8px rgba(20,24,22,0.04)" },
  chartTitle:{ margin:"0 0 16px", fontSize:15, fontWeight:700, color:"#272c2a" },
  tableCard: { background:"#fff", borderRadius:16, padding:20,
               border:"1px solid #e3e7e5", boxShadow:"0 1px 2px rgba(20,24,22,0.04), 0 2px 8px rgba(20,24,22,0.04)", marginBottom:16 },
  ...
  rankBadge: { display:"inline-block", borderRadius:10, padding:"2px 8px",
               fontSize:12, fontWeight:700 },
  mobileCardsWrap: { display:"grid", gap:10 },
  mobileCard: {
    border:"1px solid #e3e7e5", borderRadius:14, padding:12,
    background:"#f7faf8",
  },
