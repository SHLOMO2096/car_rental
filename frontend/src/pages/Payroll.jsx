...
const s = {
  ...
  input: { border: "1px solid #ccd2cf", borderRadius: 12, padding: "8px 10px", fontSize: 13 },
  btnPrimary: { background: "#2c6b5e", color: "#fff", border: "none", borderRadius: 12, padding: "9px 14px", fontWeight: 800, cursor: "pointer" },
  btnSecondary: { background: "#fff", color: "#141816", border: "1px solid #ccd2cf", borderRadius: 12, padding: "9px 14px", fontWeight: 800, cursor: "pointer" },

  kpiRow: { display: "flex", gap: 10, marginBottom: 18 },
  kpiCard: { flex: 1, background: "#fff", border: "1px solid #e3e7e5", borderRadius: 16, padding: 14, boxShadow: "0 1px 2px rgba(20,24,22,0.04), 0 2px 8px rgba(20,24,22,0.04)" },
  kpiLabel: { color: "#8e9592", fontSize: 12, fontWeight: 700 },
  kpiValue: { color: "#141816", fontSize: 22, fontWeight: 900, marginTop: 6 },

  card: { background: "#fff", border: "1px solid #e3e7e5", borderRadius: 16, padding: 16, boxShadow: "0 1px 2px rgba(20,24,22,0.04), 0 2px 8px rgba(20,24,22,0.04)", marginBottom: 18 },
